		...
		<>
			...
			<div className='bg-[#252A34] h-full grid grid-col-2 w-full gap-1 justify-center'>
				<div className='mt-32  text-white text-center '>
					...
					transition={{ delay: 1, duration: 1 }} className='  inline border-b-2 border-[#FF2E63] text-center sm:text-5xl lg:text-3xl '>
						{title}
					</motion.h1>
					<motion.p initial={{ opacity: 0}}
					whileInView={{ opacity: 1}}
					transition={{ delay: 1, duration: 2 }}  className='mt-12 opacity-80 max-w-[1000px] mx-auto lg:text-lg sm:text-md '>
						{desc}
					</motion.p>
				</div>
				<motion.div initial={{ opacity: 0}}
					whileInView={{ opacity: 1}}
					transition={{ delay: 1, duration: 2 }} className='max-w-[1400px] h-[780px] w-full m-auto py-16 px-4 relative group'>
					<div
