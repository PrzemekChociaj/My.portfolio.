		...
		<>
			...
			<div className='bg-[#252A34] h-full grid grid-col-2 w-full gap-1 justify-center'>
				...
				<div className='max-w-[1400px] h-[780px] w-full m-auto py-16 px-4 relative group'>
					...
					{/* Right Arrow */}
					<div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-9 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
