...
const Project = ({ img, title, url }) => {
	return (
		<div className='relative flex flex-col items-center justify-center h-auto w-full border-4 shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-bg-cyan-500 to-[#000000]'>
